...
const Form = ({ handleFormSubmitData }) => {
  ...
  return (
    <div className="mt-10 flex justify-center ">
      <form className="flex gap-10" onSubmit={handleSubmit(func)}>
        ...
        <input {...register('description')} className="rounded-md px-2 py-1 text-base font-semibold outline-none" type="text" placeholder="description" />
